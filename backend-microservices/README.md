...
Chạy từng service (mở 4 terminal):
bash
...
Development Tips
Chạy local development: Dùng npm run dev cho mỗi service
Test API: Dùng Postman hoặc Thunder Client
Monitor logs: Terminal riêng cho mỗi service
Database: Dùng MongoDB Compass để xem data
Project Structure
